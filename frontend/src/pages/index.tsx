          ...
          <div className="">
            <h1 className=''>all users</h1>
            {
              (users.length) ? users.map((user: any) => (
                <div key={user.id} className='flex bg-[#0ea5e9]   rounded-xl items-start  '>
                  <img
                    src={user.foto_user}
          ...
          <div className="">
...

            {
              (amis.length) ? amis.map((user: userProps) => (
                <div key={user.id} className=' bg-blue-200 rounded-2xl items-center  space-x-3 p-2 flex justify-between'>
                  <img
                    src={user.foto_user}
                    alt="Your Image Alt Text"
                    className="w-20 h-auto  rounded-full inline-block" // Adjust the width as needed
          ...
          <div className="">
            <h1 className=''>request</h1>
            {
              (received.length) ? received.map((user: any) => (
                <div key={user.id} className=' bg-slate-200 rounded-2xl items-start  '>
                  <img
