...
const YourComponent = ({ currentFileName, currentUser }: any) => {
  ...
  const handleTwoFactorVerification = async (e: any) => {
    ...
    return(
        ...
        <div className='flex  justify-center flex-col  h-96  w-[500px]  ml-12 z-20  drop-shadow-2xl  border-2 border-blue-500 rounded-2xl  items-center text-white bg-black '>
