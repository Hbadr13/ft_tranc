...
const SideMenu = ({ onlineUsersss, currentUser, users, amis }: AppProps) => {
    ...
    const [splitSidebar, setsplitSidebar] = useState<boolean>(false);
    ...
    return (
        <div className='text-sm'>
            <div className={`fixed z-50 w-[52px]  h-screen  ${light} space-y-3 ${splitSidebar ? '' : 'sm:w-[52px]'}  sm:w-[150px] transition-width duration-1000`}>
                <div className="w-[20px] h-[20px]  mx-auto mt-5 flex justify-center items-center">
                    <button onClick={handelsplitSidebar} className='w-[90%] h-[90%] bg-blue-400 duration-300  rounded-md hover:p-[11px] '>
                ...
                <div className='relative py-2 pl-2 rounde w-full bg-red-300s mt-20'>
                    ...
                    <div onClick={() => setActiveButton(1)} className={`${activeButton == 1 ? `${grey}` : light} p-1 rounded-l-full transition-padding duration-100 hover:p-2`}>
                        <Link className={`flex items-center space-x-4 p-2 rounded-full ${light} w-full`} href='/'>
                            ...
                            <span className={`hidden sm:block ${activeButton == 1 ? ' text-blue-900  font-bold' : ''} ${splitSidebar ? '' : 'sm:hidden'}`}>
                                Home
                            </span>
                        </Link>
                    </div>
                ...
                <div className='relative py-2 pl-2 rounde w-full bg-red-300s mt-10'>
                    ...
                    <div onClick={() => setActiveButton(2)} className={`${activeButton == 2 ? grey : light} p-1 rounded-l-full transition-padding duration-100 hover:p-2`}>
                        <Link className={`flex items-center space-x-4 p-2 rounded-full ${light} w-full`} href='/chat'>
                            ...
                            <span className={`hidden sm:block ${activeButton == 2 ? 'text-blue-900  font-bold' : ''} ${splitSidebar ? '' : 'sm:hidden'}`}>
                                Chat
                            </span>
                        </Link>
                    </div>
                ...
                <div className='relative py-2 pl-2 rounde w-full bg-red-300s mt-10'>
                    ...
                    <div onClick={() => setActiveButton(3)} className={`${activeButton == 3 ? grey : light} p-1 rounded-l-full transition-padding duration-100 hover:p-2`}>
                        <Link className={`flex items-center space-x-4 p-2 rounded-full ${light} w-full`} href='/profile'>
                            ...
                            <span className={`hidden sm:block ${activeButton == 3 ? 'text-blue-900  font-bold' : ''} ${splitSidebar ? '' : 'sm:hidden'}`}>
                                Profile
                            </span>
                        </Link>
                    </div>
                ...
                <div className='relative py-2 pl-2 rounde w-full bg-red-300s mt-10'>
                    ...
                    <div onClick={() => setActiveButton(4)} className={`${activeButton == 4 ? grey : light} p-1 rounded-l-full transition-padding duration-100 hover:p-2`}>
                        <Link className={`flex items-center space-x-4 p-2 rounded-full ${light} w-full`} href='/game'>
                            ...
                            <span className={`hidden sm:block ${activeButton == 4 ? 'text-blue-900  font-bold' : ''} ${splitSidebar ? '' : 'sm:hidden'}`}>
                                Play
                            </span>
                        </Link>
                    </div>
                ...
                <div className=' py-2 pl-2 rounde w-full bg-red-300s pt-28 '>
                    <div onClick={() => setActiveButton(10)} className={`p-1 rounded-l-full transition-padding duration-100 hover:p-2`}>
                        <Link className={` bg-[#aaaaaa4e]  flex items-center justify-center sm:justify-normal space-x-4 p-2 rounded-xl ${light} w-full`} href='/'>
                            ...
                            <span className={`hidden sm:block ${activeButton == 10 ? 'text-blue-900  font-bold' : ''} ${splitSidebar ? '' : 'sm:hidden'} `}>
                                LogOut
                            </span>
                        </Link>
                    </div>
