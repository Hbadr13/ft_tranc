        ...
        <div className='flex'>
            <div className={`fixed w-[63px] h-screen bg-[${light}] space-y-3  sm:w-[230px] transition-width duration-1000`}>
                <div className='relative py-2 pl-2 rounde w-full bg-red-300s mt-10'>
                    ...
                    <div onClick={() => setActiveButton(1)} className={`bg-[${activeButton == 1 ? grey : light}] p-1 rounded-l-full transition-padding duration-500 hover:p-2`}>
                    ...
                    <div className={`${activeButton == 1 ? 'block' : 'hidden'} -buttom-[8px]  right-0 absolute w-[20px] h-[16px] bg-[${grey}]`}>
                        <div className={`w-[20px] h-[16px] bg-[${light}] rounded-tr-[15px]`}></div>
                    </div>
                </div>

                <div className='relative py-2 pl-2 rounde w-full bg-red-300s mt-10'>
                    <div className={`${activeButton == 2 ? 'block' : 'hidden'} -top-[8px]  right-0 absolute w-[20px] h-[16px]   bg-[${grey}]`}>
                        <div className={`w-[20px] h-[16px] bg-[${light}] rounded-br-[15px]`}>
                        </div>
                    </div>
                    <div onClick={() => setActiveButton(2)} className={`bg-[${activeButton == 2 ? grey : light}] p-1 rounded-l-full transition-padding duration-500 hover:p-2`}>
                        <Link className={`flex items-center space-x-4 p-2 rounded-full bg-[${light}] w-full`} href='/chat'>
                    ...
                    <div className={`${activeButton == 2 ? 'block' : 'hidden'} -buttom-[8px]  right-0 absolute w-[20px] h-[16px] bg-[${grey}]`}>
                        <div className={`w-[20px] h-[16px] bg-[${light}] rounded-tr-[15px]`}></div>
                    </div>
                </div>

                <div className='relative py-2 pl-2 rounde w-full bg-red-300s mt-10'>
                    <div className={`${activeButton == 3 ? 'block' : 'hidden'} -top-[8px]  right-0 absolute w-[20px] h-[16px]   bg-[${grey}]`}>
                        <div className={`w-[20px] h-[16px] bg-[${light}] rounded-br-[15px]`}>
                        </div>
                    </div>
                    ...
                    <div className={`${activeButton == 3 ? 'block' : 'hidden'} -buttom-[8px]  right-0 absolute w-[20px] h-[16px] bg-[${grey}]`}>
                        <div className={`w-[20px] h-[16px] bg-[${light}] rounded-tr-[15px]`}></div>
                    </div>
                </div>
                ...
                <div className=' absolute bottom-40 py-2 pl-2 rounde w-full bg-red-300s mt-10'>
                    ...
                    <div className={`${activeButton == 4 ? 'block' : 'hidden'} -buttom-[8px]  right-0 absolute w-[20px] h-[16px] bg-[${grey}]`}>
                        <div className={`w-[20px] h-[16px] bg-[${light}] rounded-tr-[15px]`}></div>
                    </div>
                </div>
            </div>
