        ...
        <>
            <div className='w-full h-full'>
                <div className="w-full h-full flex justify-center items-center">
                    <div className="OnlineCard  relative  overflow-hidden w-[90%] sm:w-[80%] h-[70%] flex flex-col justify-center items-center rounded-xl">
                        ...
                        <div className=" w-full h-[90%] flex justify-center  z-40">
                            ...
                            <div className="w-[50%] h-full  flex flex-col items-center justify-center  p-4  space-y-10">
                                <div className="w-full text-center   text-[#FFF] space-y-2">
                                    ...
                                    <div className="w-full text-[#9cbdff] text-center text-xl">
                                        <div className="">Creat a Match Room and play online matches</div>
                                    </div>
                                </div>
