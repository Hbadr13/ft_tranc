    ...
    return (
        <div className='flex  flex-col  w-[20%] h-[820px] border  items-center  mt-12 border-sky-500 rounded-[30px]  '>
                                        ...
                                        <div className="   flex  h-full  flex-row space-x-2 w-full bg-bldue-600 rounded-lg justify-cente items-center space-y-1 ">
                                            <h4 className=" text-lg">{item.username}</h4>
                                            {
                                                ...
                                                item.isOwner && <div className=' flex flex-row  justify-center items-center w-full bg-bdlack'>
                                                    ...
                                                    {
                                                       item.id == currentUser.id && <button onClick={() => setClick(false)} className='flex justify-end items-end w-full '> <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 24 24">
            ...
            </div>
            {
                ...
                click == false && <div className=' bg-white  dark:bg-gray-700 h-80 w-[87%]  flex-col  rounded-lg flex justify-start items-start  shadow-md sdhadow -mt-[630px] z-30'>
