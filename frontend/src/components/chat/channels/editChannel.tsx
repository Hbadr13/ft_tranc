...
export default function EditChannel({ chatSocket, setMyStatusInRoom, currentUser, users, Room }: { chatSocket: Socket, setMyStatusInRoom?: (value: participantsProps) => void | undefined, currentUser: userProps, users: userProps[], Room: channelProps }) {
            ...
            {Room.id && <div className={`  bg-gray-f100  ${click != 0 ? 'blur-[1.2px]' : null}   w-full h-full  rounded-xl p-3  flex justify-start items-start`}>
                <div className="w-full h-full flex-col justify-center items-center">
                    <div className="flex-col justify-start items-center flex ">
                        ...
                        <div className=" max-w-[340px]  w-auto h-14 p-3  break-all   text-xl overflow-y-scroll scrollbar-hide  ">
