                ...
                click != 0 && <div className=' bg-white  bg-blgdack dark:bg-gray-700 h-auto w-[87%]  flex-col  rounded-lg flex justify-start items-start  shadow-md sdhadow -mt-[630px]  z-40 '>
...

                    {
                        click == 2 && <div className='w-full flex flex-col bg-fslate-400'>
                            ...
                            <button className='border p-2' onClick={() => handlParticipants('banned')}>banned</button>
                            <button className='border p-2' onClick={() => handlParticipants('no banned')}>no banned</button>
                        </div>
                    }
                    {
