            ...
            <div className='flex flex-col justify-cenfter items-centefr'>
              ...
              <div className='bg-grajy-400 p-4 '>
                ...
                <div className=" flex  justify-center">
                  <select className={`focus:outline-none ${Type == 'public' && ' bg-green-200'}  ${Type == 'private' && ' bg-red-200'}  ${Type == 'protected' && ' bg-yellow-200'}  border border-sky-200 p-2 mt-2 w-[40%] rounded-full shadow-xl`} onChange={(e) => setType(e.target.value)}>
