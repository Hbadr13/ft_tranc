...
export default function ChannelsConversationList({ msg2, users, currentUser, setRoom, setjoinchannel, Room, setJoinRoom }: { msg2: string, users: userProps[], currentUser: userProps, setRoom: (value: channelProps) => void, setjoinchannel: (value: boolean) => void, Room: channelProps, setJoinRoom: (value: channelProps) => void, }) {
