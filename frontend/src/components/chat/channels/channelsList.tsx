    ...
    <div className=' w-full h-full flex justify-start items-center flex-col'>
      {
        !click && <button onClick={() => setClick('create')} className=" text-white  w-[90%] -mt-4 bg-blue-400 rounded-full justify-center  h-10 items-center  duration-300 hover:scale-105">
          <div className=" justify-center items-center flex space-x-2">
            ...
            <h1 className="hidden md:block">Create New Channel</h1>
          </div>
        </button>
      }
        ...
        {click == 'start' && <div className=" bg-skfy-300 w-full h-full flex  flex-col items-cfenter justify-cefnter shadowf-xl drop-shadow-fxl   rounded-2xl">
          <div className="  w-full ">
            ...
            <div className=' bgf-sky-200 flex flex-col h-[670px]  -mt-6 overflow-y-scroll shadffow-xl scrollbar-hide'>
              <h1 className='w-full hidden md:block ml-10 text-xl'>La list des Channels</h1>
              {
                allChannel.length != 0 ? <div> {
                  allChannel.map((item, index) => (
                    <button key={index} onClick={() => joinchanle(item)} className="h-16 mt-3 w-full p-2 bg-white justify-between items-center inline-flex  hover:shadow-lg   border-2 border-sky-400  hover:bg-sky-100 duration-1000  transition shahydow-md rounded-[20px] ">
                  ...
                  ))}</div> : <div className='mt-10 w-full justify-center  flex'>list des channels is empty</div>
              }
            </div>
          </div>
        </div>}
          ...
          <div className="  bg-slatfe-600 borhder bogjrder-sky-500  flex  flex-col items-center justify-start h-[610px]  mt-1  overflow-y-scroll shadffow-xl drofp-shadow-xl scrollbar-hide">
            {
              channel.map((item, index) => (
                <button key={index} onClick={() => setRoom(item)} className={` xl:bgf-slate-400 h-16 mt-3 w-full md:p-2 ${item.id == Room.id ? 'md:bg-blue-200 md:shadow-lg md:shadowf-black ' : 'md:bg-white md:hover:shadow-lg md:hover:bg-blue-200 '}  justifyf-center  items-center inline-flex   md:border-2 border-sky-400 shahydow-md rounded-xl`}>
