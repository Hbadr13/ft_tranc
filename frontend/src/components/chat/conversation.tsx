                ...
                ((receiver.id != 0 || Room.id != 0)) ? (
                    <>
                        <div className=' w-full flex justify-center items-center'>
                            ...
                            <div className=' flex w-[97%] bg-gray-100 h-16 rounded-xl border-2 justify-start items-center  border-sky-400 wml-3 mt-2 '>
                                ...
                                {!button && <div className='absolute ml-[200px]  md:ml-[320px] lg:ml-[690px]'>
                                    <button className=' flex justify-center items-center hover:scale-110 duration-300'><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 24 24" fill="none">
                                ...
                                <div className=' w-full h-auto flex lg:hidden justify-end items-center  mr-2'>
                                    {
                                        ...
                                        <div className='  flex absolute z-30 justify-center items-center bgf-slate-600'>
                                            ...
                                            <div className=" bg-blfack w-72  absolute z-20 h-[650px]  mr-[233px] mt-[720px] bg-gray-100  border-2 border-sky-400 rounded-xl p-4">
                                                ...
                                                {button == true &&
                                                    <div className="w-full h-full flex-col justify-start items-center   gasp-[26px]f flex">
