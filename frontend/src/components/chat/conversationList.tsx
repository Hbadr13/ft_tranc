...
export default function ConversationList({ amis, setReceiver, setButton, currentUser, users, setConv }: { amis: userProps[], setReceiver: (value: userProps) => void, setButton: (value: boolean) => void, currentUser: userProps, users: userProps[], setConv: (value: number) => void }) {

    const [click, setClick] = useState(true)

    return (
        <div className="  dark:bg-slate-800 bg-gray-100 p-4 ml-6 mt-12 md:[400px] lg:min-w-[420px] h-[820px]    flex-col justify-start items-start gap-5 inline-flex rounded-[30px] border  border-sky-500">
